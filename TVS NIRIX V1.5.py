...
class MainWindow(QWidget):
    ...
    def __init__(self):
        ...
        # Maximize the window to fit the primary screen
    ...
    def run_test(self, library_name, function_name, vin_number, api_url):
        ...
        try:
            ...
            if library_name == "TPMS" and function_name in ["WRITE_TPMS_FRONT", "WRITE_TPMS_REAR"]:
                output = test_function(vin_number)  # Pass only vin_number for TPMS-specific functions
            elif library_name == "TPMS" or function_name in ["MCU_Phase_Offset", "MCU_Vehicle_ID", "API_CALL"]:
